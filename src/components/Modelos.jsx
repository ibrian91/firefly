...
const ModelosMenu = () => {
  return (
    <div className="flex flex-col items-center gap-4 py-16 text-gray-800" id="speciality">
      <h1 className="text-3xl font-bold text-gray-800">MAS DE 25 MODELOS</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex-1 rounded-lg border border-gray-300 p-4">
              <h3 className="font-semibold text-gray-800 mb-2">Iluminación Estándar</h3>
            ...
            {/* Sección 2 */}
            <div className="flex-1 rounded-lg border border-gray-300 p-4">
              <h3 className="font-semibold text-gray-800 mb-2">Iluminación Profesional</h3>
              <p className="text-gray-600">
            ...
            {/* Sección 3 */}
            <div className="flex-1 rounded-lg border border-gray-300 p-4">
              <h3 className="font-semibold text-gray-800 mb-2"> Iluminación de Alta Tecnología</h3>
              <p className="text-gray-600">
